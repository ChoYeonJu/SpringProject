...
<!-- 로그인 상태 end -->
			...
			<tr>
				...
				<div id="searchresult" style="position: absolute; z-index: 1; display: none;">
					<div id="searchlist" class="auto-body">검색결과1<br><a href="alert('aaaaaaaaaa');">검색결과2</a><br>검색결과3<br>검색결과4<br>검색결과2<br>검색결과3<br>검색결과4<br>검색결과2<br>검색결과3<br>검색결과4<br>검색결과2<br>검색결과3<br>검색결과4</div>
				</div>
				</td>
			</tr>
			</table>
