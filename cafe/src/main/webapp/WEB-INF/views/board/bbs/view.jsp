        ...
        $(document).ready(function() {
        	...
        	$('#modiBtn').click(function() {
        		if('${userInfo == null}' == 'true') {
	        		...
	        		var paraForm = $('#paraForm');
	        		paraForm.attr('action', '${root}/bbs/modify.cafe').attr('method', 'get');
	        		paraForm.submit();
        		}
        	});
        	...
        	$('#delBtn').click(function() {
        		if('${userInfo == null}' == 'true') {
	        		...
	        		if(confirm("글을 삭제하시겠습니까?")) {
		        		...
		        		$(document).find('[name="seq"]').val('${article.seq}');
		        		var paraForm = $('#paraForm');
		        		paraForm.attr('action', '${root}/bbs/delete.cafe').attr('method', 'get');
		        		paraForm.submit();
	        		}
        		}
        	});
            ...
            $('#filedown').click(function() {
        		alert("원본 :  ${article.originalFile}      실제 :  ${article.saveFile}");
        		$(document).find('[name="sfolder"]').val('${article.saveFolder}');
        		$(document).find('[name="ofile"]').val('${article.originalFile}');
        		$(document).find('[name="sfile"]').val('${article.saveFile}');
        		var downForm = $('#downForm');
        		downForm.attr('action', '${root}/bbs/download.cafe').attr('method', 'get');
        		downForm.submit();
        	});
        });
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <strong>${article.originalFile} (${article.viewSize})</strong>
                        <a href="#" id="filedown">[다운로드]</a>
                        </c:if>
                        </td>
                    </tr>
                    <tr>
