		...
		$(document).ready(function() {
			...
			$('#writeBtn').click(function() {
				...
				if($.trim($('#subject').val()) == '') {
	        		...
	        		writeForm.attr('action', '${root}/bbs/write.cafe').attr('method', 'post');
	        		writeForm.submit();
				}
			});
            ...
            <div class="form-group">
	        	<form id="writeForm" class="form-horizontal" enctype="multipart/form-data" action="#">
                    ...
                    <fieldset>
                        ...
                        <div class="col-sm-11">
                        	<textarea id="content" name="content" rows="10" cols="100" style="width:100%; height:412px;" placeholder="내용"></textarea>
                        </div>
                        <div class="form-group">
