		...
		$(document).ready(function() {
			...
			$('#writeBtn').click(function() {
				...
				if($.trim($('#subject').val()) == '') {
	        		...
	        		$(document).find('[name="gcode"]').val('${article.gcode}');
	        		$(document).find('[name="depth"]').val('${article.depth}');
	        		$(document).find('[name="step"]').val('${article.step}');
	        		$(document).find('[name="pseq"]').val('${article.seq}');
	        		var writeForm = $('#writeForm');
	        		writeForm.attr('action', '${root}/reboard/reply.cafe').attr('method', 'post');
	        		writeForm.submit();
				}
			});
...
<!-- Center ======================================================================================= -->
        <div class="col-sm-9">
            ...
            <div class="form-group">
	        	<form id="writeForm" name="writeForm" class="form-horizontal" action="#">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="subject" name="subject" class="form-control" placeholder="제목" value="Re : ${article.subject}">
                            </div>
                        ...
                        <div class="col-sm-11">
                        	<textarea id="content" name="content" rows="10" cols="100" style="width:100%; height:412px;" placeholder="내용"><br><br><br>---------------------------------------------------------------------------------------------[원문]<br><br>${article.content}</textarea>
                        </div>
                    </fieldset>
                </form>
        	</div>
