...
<!-- Center ======================================================================================= -->
        ...
        $(document).ready(function() {
        	...
        	$('.article_list>tr').click(function() {
        		...
        		var paraForm = $('#paraForm');
        		paraForm.attr('action', '${root}/reboard/view.cafe').attr('method', 'get');
        		paraForm.submit();
     		});
        	...
        	$('#boardsearch').click(function() {
        		...
        		sForm.attr('action', '${root}/reboard/list.cafe').attr('method', 'get');
        		sForm.submit();
        	});
            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-left">
                        	<img src="${root}/img/board/blank.png" width="${article.depth * 15}" height="1">
                        	${article.subject}
