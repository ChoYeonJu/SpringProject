		...
		$(document).ready(function() {
			...
			$('#modifyBtn').click(function() {
				...
				if($.trim($('#subject').val()) == '') {
	        		...
	        		$(document).find('[name="savePicture"]').val('${article.savePicture}');
	        		$(document).find('[name="originalPicture"]').val('${article.originalPicture}');
	        		var modifyForm = $('#modifyForm');
	        		modifyForm.attr('action', '${root}/album/modify.cafe').attr('method', 'post');
	        		modifyForm.submit();
				}
			});
...
<!-- Center ======================================================================================= -->
        <div class="col-sm-9">
            ...
            <div class="form-group">
	        	<form id="modifyForm" name="modifyForm" class="form-horizontal" enctype="multipart/form-data" action="#">
		        	...
		        	<input type="hidden" id="savePicture" name="savePicture"/>
		        	<input type="hidden" id="originalPicture" name="originalPicture"/>
                    <fieldset>
                        <div class="form-group">
            ...
            <div class="pull-right">
            	<button type="button" id="modifyBtn" class="btn btn-sm btn-default" data-backdrop="static">글수정</button>
                <button type="button" id="cancelBtn" class="btn btn-sm btn-default" data-backdrop="static">취소</button>
            </div>
